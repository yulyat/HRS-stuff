...
/* 
this do file uses the financial assets Q file, and counts financial assets, IRAS, pensions income
and annuities.
...
* have financial assets: CDS, Bonds, stocks, 
...
* 3. other annuities: LS270 block: annuQ2:
...
* 4. Receiving income from pensions? Q215 loop penincome
...
cap drop  penincome_self penincome_partner
    ...
    gen penincome_self = 0
	replace penincome_self = LQ218 if LQ218!=. 
    replace penincome_self = 1 if inlist(LQ218, 98, 99)
    replace penincome_self = . if mi(LQ215)

    gen penincome_partner = 0
	replace penincome_partner = LQ244 if LQ244!=.
	replace penincome_partner = 1 if inlist(LQ244, 98, 99)
    replace penincome_partner = . if mi(LQ215)
